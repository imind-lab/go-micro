...
`
	...
	dir := "./" + data.Domain + "/" + data.Project + "/" + data.Service + "/infrastructure/deploy/helm/" + data.Service + "/"
...
image:
  repository: registry.cn-beijing.aliyuncs.com/{{.Project}}/{{.Service}}
  pullPolicy: Always
...
`
	...
	dir = "./" + data.Domain + "/" + data.Project + "/" + data.Service + "/infrastructure/deploy/helm/" + data.Service + "/templates/"
...
`
	...
	dir = "./" + data.Domain + "/" + data.Project + "/" + data.Service + "/infrastructure/deploy/helm/" + data.Service + "/conf/"
...
`
	...
	dir = "./" + data.Domain + "/" + data.Project + "/" + data.Service + "/infrastructure/deploy/helm/" + data.Service + "/templates/tests/"
